...
func (c *ApiClient) LookupNeighborhoodCode(ctx context.Context, cfg *config.Config, lat, lon float64) (*models.NeighborhoodRegionCodes, error) {
	...
	result := &models.NeighborhoodRegionCodes{
